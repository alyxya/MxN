...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--secondary-query-learning-rate", type=float, default=0.0001, help="Step size for secondary past-token query vectors")
    p.add_argument("--secondary-unembed-learning-rate", type=float, default=0.0001, help="Step size for secondary past-token unembedding vectors")
